...
@section('content')
    ...
    <section class="content no-print">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                @component('components.widget', ['class' => 'box-solid'])
                    ...
                    {!! Form::hidden('construction_id', null, ['id' => 'construction_id']) !!}
                    ...
                    <div class="col-md-4 pull-right col-sm-6">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('is_construction', 1, false, ['id' => 'is_construction']) !!} Construction ?
                            </label><button type="button" data-toggle="modal" data-target="#constructionModal"
                                class="btn btn-link"><i class="fa fa-external-link"></i></button>
                        </div>
                    </div>
        ...
        @include('sale_pos.partials.construction_modal')
...
@section('javascript')
    ...
    <script>
        $(document).ready(function() {
            $('#createConstructionModal').on('hidden.bs.modal', function() {
