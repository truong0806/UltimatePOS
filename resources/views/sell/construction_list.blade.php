    ...
    <section class="content no-print">
        ...
        @component('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.all_sales')])
            ...
            @if (auth()->user()->can('direct_sell.view') ||
                ...
                @endphp
                <table class="table table-bordered table-striped" id="sell_construction_table">
                    <thead>
                        <tr>
                            <th>@lang('messages.action')</th>
                            <th>@lang('messages.date')</th>
                            <th>@lang('sale.invoice_no')</th>
                            <th>@lang('messages.constructions')</th>
                    ...
                    <tfoot>
                        <tr class="bg-gray font-17 footer-total text-center">
                            ...
                            <td class="footer_shipping_status_count"></td>
                            <td class="footer_total_items_count"></td>
...
@section('javascript')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#sell_list_filter_date_range').daterangepicker(
                ...
                function(start, end) {
                    $('#sell_list_filter_date_range').val(start.format(moment_date_format) + ' ~ ' + end.format(
                        moment_date_format));
                    sell_construction_table.ajax.reload();
                }
            );
            ...
            sell_construction_table = $('#sell_construction_table').DataTable({
                processing: true,
                serverSide: true,
                scrollY: '75vh',
                scrollX: true,
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            return '<span class="w-50 text-center text-nowrap">' + data + '</span>';
                        }
                    },
                    {
                        data: 'final_total',
                        name: 'final_total',
                        render: function(data) {
                            return '<span class="w-50 text-center text-nowrap px-4">' + data +
                                '</span>';
                        }
                    },
                    {
                ...
                "fnDrawCallback": function(oSettings) {
                    __currency_convert_recursively($('#sell_construction_table'));
                },
