...
<div class="row">
    <div class="col-md-12">
        ...
        {{-- <div class="col-sm-5 @if ($contact->type != 'both')  @endif">
            <strong>@lang('lang_v1.introducer_name')</strong>
            <p class="text-muted">
                <span>
                    {{ $introducer->name }} ({{ $introducer->contact_id }})</span>
            </p> 
            <strong>@lang('lang_v1.commission_percentage')</strong>
            <p class="text-muted">
                <span class="display_currency">
                    {{ number_format($contact->commission_percentage, 0) }} </span> %
            </p>
            <strong>@lang('lang_v1.commission_amount')</strong>
            <p class="text-muted">
                <span class="display_currency" data-currency_symbol="true">
                    {{ $contact->commission_amount }}</span>
            </p>
