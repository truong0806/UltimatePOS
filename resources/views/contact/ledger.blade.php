...
<div class="col-md-6 col-sm-6 col-xs-6 text-right align-right @if (!empty($for_pdf)) width-50 f-left @endif">
    ...
    <table
        ...
        @endif
        @if ($ledger_details['total_construction_invoice'])
            @if ($contact->type == 'customer' || $contact->type == 'both')
                <tr>
                    <td>@lang('lang_v1.total_individual_invoice')</td>
                    <td class="align-right">@format_currency($ledger_details['total_individual_invoice'])</td>
                </tr>
            @endif

            <tr>
                <td>@lang('sale.total_individual_paid')</td>
                <td class="align-right">@format_currency($ledger_details['total_individual_paid'])</td>
            </tr>
            ...
            @if ($contact->type == 'customer' || $contact->type == 'both')
                <tr>
                    <td>@lang('lang_v1.total_construction_invoice')</td>
                    <td class="align-right">@format_currency($ledger_details['total_construction_invoice'])</td>
                </tr>
            @endif

            <tr>
                <td>@lang('sale.total_construction_paid')</td>
                <td class="align-right">@format_currency($ledger_details['total_construction_paid'])</td>
            </tr>
        @endif
        ...
        @if ($ledger_details['total_construction_invoice'])
            <tr>
                <td><strong>@lang('lang_v1.balance_individual_due')</strong></td>
                <td class="align-right">@format_currency($ledger_details['balance_individual_due'])</td>
            </tr>
            <tr>
                <td><strong>@lang('lang_v1.balance_construction_due')</strong></td>
                <td class="align-right">@format_currency($ledger_details['balance_construction_due'])</td>
            </tr>
        @endif
