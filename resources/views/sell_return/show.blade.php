<div class="modal-dialog modal-xl no-print" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="modalTitle"> @lang('lang_v1.sell_return') (<b>@lang('sale.invoice_no'):</b>
                {{ $sell->return_parent->invoice_no }})
            </h4>
        </div>
        <div class="modal-body">
            <div class="row">
                <div class="col-sm-6 col-xs-6">
                    ...
                    <strong>@lang('construction.construction_name'): </strong>{{ $sell->constructions_name . ' - ' }} <a data-href=""
                        target="_blank"
                        href="/UltimatePOS/public/constructions/{{ $sell->construction_id }}">{{ $sell->construction_id }}</a>
                    <br>
                    <strong>@lang('contact.customer'): </strong>{{ $sell->contact->name . ' - ' }} <a data-href=""
                        target="_blank"
                        href="/UltimatePOS/public/constructions/{{ $sell->contact->id }}">{{ $sell->id }}</a>
                    <br>
