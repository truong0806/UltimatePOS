...
@section('content')
    ...
    <section class="content no-print">
        ...
        {!! Form::hidden('construction_id', $sell->construction_id) !!}
        <div class="box box-solid">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        @if (!empty($sell->construction_id))
                            <strong>@lang('construction.construction_name'):</strong>
                            {{ $sell->constructions_name . ' - ' }}<a data-href="" target="_blank"
                                href="/UltimatePOS/public/constructions/{{ $sell->construction_id }}">{{ $sell->construction_id }}</a>

                            <br>
                        @endif
                        <strong>@lang('contact.customer'):</strong>
                        {{ $sell->contact->name . ' - ' }}<a data-href="" target="_blank"
                            href="/UltimatePOS/public/contacts/{{ $sell->contact->id }}">{{ $sell->contact->id }}</a>
                        <br>
