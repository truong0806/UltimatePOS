    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('default_sales_discount', @num_format($business->default_sales_discount), [
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::select('default_sales_tax', $tax_rates, $business->default_sales_tax, [
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::select(
                    ...
                    [0 => __('lang_v1.add_item_in_new_row'), 1 => __('lang_v1.increase_item_qty')],
                    $business->item_addition_method,
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox('pos_settings[enable_sales_order]', 1, !empty($pos_settings['enable_sales_order']), [
                            'class' => 'input-icheck',
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox('pos_settings[is_pay_term_required]', 1, !empty($pos_settings['is_pay_term_required']), [
                            'class' => 'input-icheck',
                            'id' => 'is_pay_term_required',
        ...
        {{-- <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::select('sales_cmsn_agnt', $commission_agent_dropdown, $business->sales_cmsn_agnt, [
                        'class' => 'form-control select2',
                        'style' => 'width: 100%;',
                    ]) !!}
                </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::select(
                        ...
                        ['invoice_value' => __('lang_v1.invoice_value'), 'payment_received' => __('lang_v1.payment_received')],
                        !empty($pos_settings['cmmsn_calculation_type']) ? $pos_settings['cmmsn_calculation_type'] : null,
                        ['class' => 'form-control select2', 'style' => 'width: 100%;', 'id' => 'cmmsn_calculation_type'],
                    ) !!}
                </div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox(
                            'pos_settings[is_commission_agent_required]',
                            1,
                            !empty($pos_settings['is_commission_agent_required']),
                            ['class' => 'input-icheck', 'id' => 'is_commission_agent_required'],
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox('pos_settings[enable_payment_link]', 1, !empty($pos_settings['enable_payment_link']), [
                            'class' => 'input-icheck',
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::text('pos_settings[razor_pay_key_id]', $pos_settings['razor_pay_key_id'] ?? '', [
                    'class' => 'form-control',
                    'id' => 'razor_pay_key_id',
                ]) !!}
            </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::text('pos_settings[razor_pay_key_secret]', $pos_settings['razor_pay_key_secret'] ?? '', [
                    'class' => 'form-control',
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::text('pos_settings[stripe_public_key]', $pos_settings['stripe_public_key'] ?? '', [
                    'class' => 'form-control',
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::text('pos_settings[stripe_secret_key]', $pos_settings['stripe_secret_key'] ?? '', [
                    'class' => 'form-control',
