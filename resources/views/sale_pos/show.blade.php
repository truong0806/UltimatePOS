        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="@if (!empty($export_custom_fields)) col-sm-3 @else col-sm-4 @endif">
                    ...
                    @endif
                    @if ($commission_agent != '')
                        <b>{{ __('messages.commission_agent') }}:</b>
                        @if (!empty($commission_agent))
                            {{ $commission_agent->surname . ' ' . $commission_agent->first_name . ' (' . $commission_agent->id . ')' }}
                        @endif
                    @endif
                ...
                <div class="@if (!empty($export_custom_fields)) col-sm-3 @else col-sm-4 @endif">
                    ...
                    <b>{{ __('messages.constructions') }}:</b> {{ $construction->name ?? 'None' }}<br>

                    @if (!empty($sell->billing_address()))
                        <b>{{ __('messages.billing_address') }}: {{ $sell->billing_address() }}
                        @else
                            <b>{{ __('messages.contact_address') }}:</b> {!! $sell->contact->contact_address !!}
