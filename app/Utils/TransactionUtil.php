...
class TransactionUtil extends Util
{
     ...
     * @return array
     */
    public function getReceiptDetails($transaction_id, $location_id, $invoice_layout, $business_details, $location_details, $construction_details, $receipt_printer_type)
    {
        $il = $invoice_layout;
        ...
        $output = [
            ...
            'construction_name' => ($il->show_location_name == 1) ? $construction_details->name : '',
