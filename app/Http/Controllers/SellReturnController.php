...
class SellReturnController extends Controller
{
    ...
    public function add($id)
    {
        ...
        $sell = Transaction::where('business_id', $business_id)
            ...
            ->select('transactions.*',  DB::raw('IFNULL(cs.name, "") as constructions_name'))
    ...
    private function receiptContent(
        ...
        if ($location_details->print_receipt_on_invoice == 1) {
            ...
            $receipt_details = $this->transactionUtil->getReceiptDetails($transaction_id, $location_id, $invoice_layout, $business_details, $location_details, null, $receipt_printer_type);
