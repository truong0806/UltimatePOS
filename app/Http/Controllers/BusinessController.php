...
class BusinessController extends Controller
{
    ...
    */
    ...
    public function getBusinessSettings()
    {
        ...
        $pos_settings['introducer_commission_contact'] = $business->default_commission_percent;
    ...
    public function postBusinessSettings(Request $request)
    {
        ...
        try {
            ...
            if (! empty($request->input('introducer_commission_contact'))) {
                $business_details['default_commission_percent'] = $request->input('introducer_commission_contact');
            } else {
                $business_details['default_commission_percent'] = 0;
            }
